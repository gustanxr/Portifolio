...
export function Projects() {
  ...
  return (
    <section id="projetos" aria-labelledby="titulo-projetos" className="page-container border-t border-line pt-14 max-[760px]:pt-11">
      <div data-reveal className="mb-[34px] flex items-end justify-between gap-6 max-[760px]:flex-col max-[760px]:items-start max-[760px]:gap-4">
      ...
      {hasProjects ? (
        <div data-reveal><ProjectCarousel projects={projects} /></div>
      ) : (
        <div data-reveal className="relative flex min-h-[260px] items-center gap-8 rounded-lg border border-line bg-surface p-[42px] max-[760px]:block max-[760px]:px-6 max-[760px]:py-7">
